        ...
        var updateSort = function() {
            ...
            if(sortColumn.index) {
                allTrs.sort(function(tr1,tr2){
                    ...
                    if($(tr1col).data('search') && $(tr1col).data('search').length > 0) {
                        tr1Sortable = $(tr1col).data('search');
                    }
                    if($(tr2col).data('search') && $(tr2col).data('search').length > 0) {
                        tr2Sortable = $(tr2col).data('search');
                    }
